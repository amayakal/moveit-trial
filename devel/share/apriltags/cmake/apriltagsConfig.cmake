...
if("TRUE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/aniket/moveit/src/apriltags)
  set(apriltags_DEVEL_PREFIX /home/aniket/moveit/devel)
  ...
  set(apriltags_INSTALL_PREFIX /home/aniket/moveit/install)
...
if(NOT "/home/aniket/moveit/src/apriltags/include;/usr/include/eigen3;/usr/include/opencv;/usr/include " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "/home/aniket/moveit/src/apriltags/include;/usr/include/eigen3;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aniket/moveit/src/apriltags/${idir}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
    endif()
