...
if("TRUE" STREQUAL "TRUE")
  set(industrial_trajectory_filters_SOURCE_PREFIX /home/aniket/moveit/src/industrial_core-indigo-devel/industrial_trajectory_filters)
  set(industrial_trajectory_filters_DEVEL_PREFIX /home/aniket/moveit/devel)
  ...
  set(industrial_trajectory_filters_INSTALL_PREFIX /home/aniket/moveit/install)
...
if(NOT "/home/aniket/moveit/src/industrial_core-indigo-devel/industrial_trajectory_filters/include " STREQUAL " ")
  set(industrial_trajectory_filters_INCLUDE_DIRS "")
  set(_include_dirs "/home/aniket/moveit/src/industrial_core-indigo-devel/industrial_trajectory_filters/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'industrial_trajectory_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aniket/moveit/src/industrial_core-indigo-devel/industrial_trajectory_filters/${idir}'.  Ask the maintainer 'Shaun Edwards <sedwards@swri.org>' to fix it.")
    endif()
